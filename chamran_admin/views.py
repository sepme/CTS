...
def addTask(request):
    ...
    if deadline is None :
        text = """\U0001F538 یک وظیفه برای پروژه شما تعیین شده است.
\U0001F3F7 نام وظیفه : {}
\U0000270F\U0000FE0F افراد مسئول : {}
\U0001F53B برای اطلاعات بیشتر می توانید دکمه «مشاهده پروژه» در زیر این پیام را بزنید.""".\
            format(task.description,involved_user_username)
    else:
        text = """\U0001F538 یک وظیفه برای پروژه شما تعیین شده است.
\U0001F3F7 نام وظیفه : {}
\U0000270F\U0000FE0F افراد مسئول : {}
\U000023F3 مهلت انجام : {}
\U0001F53B برای اطلاعات بیشتر می توانید دکمه «مشاهده پروژه» در زیر این پیام را بزنید.""".\
