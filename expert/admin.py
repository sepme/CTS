...
admin.site.register(models.ExpertProjectHistory)
admin.site.register(models.ResearcherEvaluateExpert)
admin.site.register(models.IndustryEvaluateExpert)
admin.site.register(models.RequestResearcher)
admin.site.register(models.TempExpertForm)
admin.site.register(models.TempPaperRecord)
admin.site.register(models.ResearchGain)
